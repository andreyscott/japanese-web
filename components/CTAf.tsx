...
¥4,980が</span>
                                    ...
                                    {/* number  */}
                                    <h2 className='text-4xl  p-0 md:text-3xl mr-2 font-medium text-white'>
                                    ¥0
                                    </h2>
...
利用料が
                                    ...
                                    {/* number  */}
                                    <h2 className='text-4xl md:text-3xl mr-2 md:mr-0 font-medium text-white'>
        ...
        <div className=' w-full pb-4 '>
                        {/* 3 icons here svg first flex direction column justify center align center md: grid  */}
                        <div className='flex flex-col md:justify-center justify-start md:items-center items-start w-full'>
...
月額利用料が
                                    ...
                                    {/* number  */}
                                    <h2 className='text-4xl p-0 md:text-3xl mr-2 md:mr-0 font-medium text-white'>
                                    半額
                                    </h2>
