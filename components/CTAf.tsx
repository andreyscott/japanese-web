...
export const CTAF = () => {
    return (
       ...
       {/* first flex direction column justify center align center */}
         <div className='flex flex-col justify-center items-center bg-black py-14 md:py-0 md:bg-[#222222] w-screen'>
...
¥4,980が</span>
        ...
        <div className=' w-full my-1  px-2 md:px-0'>
                      ...
                      <div className='flex flex-row  justify-between md:justify-start  xl:justify-center w-80 md:px-1 lg:px-3 lg:w-[21rem] md:w-64  ml-7 md:ml-0 lg:ml-2  items-center'>
                                {/* Icon 1 */}
...
<p >
    <span className='text-base md:text-sm lg:px-2 xl:px-3 lg:text-lg gap-y-5 font-medium text-white'>   初月の
    <br />
利用料が
</span>
</p>
        ...
        <div className=' w-full pb-4 '>
                      ...
                      <div className='flex flex-row justify-between  md:justify-center px-3  w-80 md:px-1 lg:px-3 lg:w-[21rem] md:w-64 ml-7 items-center'>
                                ...
                                <div className='flex flex-col justify-center items-center'>
<p>
    <span className='text-base md:text-sm lg:px-1 xl:px-3 lg:text-lg gap-y-5 font-medium text-white'>  専用ロッカー
    <br />
月額利用料が
</span>
</p>
