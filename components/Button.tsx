...
const Button = () => {
  return (
    <div>
      ...
      <button className="flex flex-row relative text-center items-center justify-center  p-2 md:p-3 w-96 md:-[430px]  h-12 md:h-10 mb-2 bg-white hover:bg-primaryRed text-primaryRed hover:text-white border-2 border-primaryRed rounded-lg">
