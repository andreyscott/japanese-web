...
const Button = () => {
  return (
    <div>
      ...
      <button className="flex flex-row relative text-center items-center justify-center  p-2 w-[23rem] md:w-[500px] md:mb-4 h-12 md:h-14 mb-2 bg-white hover:bg-primaryRed text-primaryRed hover:text-white border-2 border-primaryRed rounded-lg">
