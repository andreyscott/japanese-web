...
const Button = () => {
  return (
    <div>
      ...
      <button className="flex flex-row relative text-center items-center justify-center  p-2 w-[23rem] md:w-[49rem]  md:mb-4 h-12 mb-2 bg-white hover:bg-primaryRed text-primaryRed hover:text-white border-2 border-primaryRed rounded-lg">
        <p className="font-extrabold text-xl tracking-wider md:text-2xl">webから体験予約をする!!</p>
